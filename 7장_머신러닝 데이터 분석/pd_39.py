...
df.columns = ['id','clump','cell_size','cell_shape','adhesion','epithlizal','bare_nuclei','chromatin','normal_nucleoli','mitoses','class']
...
# 3. 데이터셋 구분 - 훈련용(train data)/검증용(test data)
    ...
    # 속성(변수) 선택
X=df[['clump','cell_size','cell_shape','adhesion','epithlizal','bare_nuclei','chromatin','normal_nucleoli','mitoses']] # 설명 변수X
y=df['class'] # 예측 변수 Y
